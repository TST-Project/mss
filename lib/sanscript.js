...
(function(Sanscript) {
    ...
    var schemes = Sanscript.schemes = {
        ...
        tamil: {
            ...
            other_marks: 'ஂ ஃ \u{11303}'.split(' '),
            virama: ['்'],
            consonants: 'க \u{11316} \u{11317} \u{11318} ங ச \u{1131B} ஜ \u{1131D} ஞ ட \u{11320} \u{11321} \u{11322} ண த \u{11325} \u{11326} \u{11327} ந ப \u{1132B} \u{1132C} \u{1132D} ம ய ர ல வ ஶ ஷ ஸ ஹ ழ ள ற ன க்ஷ ஜ்ஞ'.split(' ').reverse(),
            symbols: '௦ ௧ ௨ ௩ ௪ ௫ ௬ ௭ ௮ ௯ ௐ ऽ । ॥ ௰ ௱ ௲ \u{11FFF}'.split(' '),
            other: '        ற'.split(' ')
        },
        ...
        iast: {
            ...
            virama: [''],
            //skip: ['_'],
            consonants: 'k kh g gh ṅ c ch j jh ñ ṭ ṭh ḍ ḍh ṇ t th d dh n p ph b bh m y r l v ś ṣ s h ḻ ḷ ṟ ṉ kṣ jñ'.split(' ').reverse(),
